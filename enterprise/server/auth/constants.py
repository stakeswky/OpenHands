...
ENABLE_BITBUCKET_DATA_CENTER = os.getenv('ENABLE_BITBUCKET_DATA_CENTER', '').strip()
BITBUCKET_DATA_CENTER_CLIENT_ID = os.getenv('BITBUCKET_DATA_CENTER_CLIENT_ID', '').strip()
